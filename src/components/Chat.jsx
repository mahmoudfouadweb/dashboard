...
const Chat = () => {
  const { setIsChat } = useStateContext();
  return (
    <div className=" bg-white dark:bg-secondary-dark-bg  absolute bottom-[-380px] left-[-250px] w-80 h-96 rounded-xl">
      <div className="flex justify-between border-b-2 border-solid border-gray-200">
        <div className="notification-card  m-4 font-semibold ">Chat</div>
        <button
          type="button"
